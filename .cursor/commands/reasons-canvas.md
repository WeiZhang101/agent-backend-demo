...
**Input**: Business context/requirement description after `/reasons-canvas`
...
```
# Text description
/reasons-canvas Implement user registration functionality, supporting email verification and mobile phone binding

# File reference
/reasons-canvas @requirements/user-registration.md

# Combined (text + file reference)
/reasons-canvas @requirements/user-registration.md additionally requires support for third-party OAuth login

# Multiple file references
/reasons-canvas @requirements/user-registration.md @docs/api-spec.yaml
```
...
5. **Save the fully-populated structured prompt to file**
   ...
   - Write the complete, fully-populated structured prompt to `aupro/prompt/<file-name>.md`

   c. **Show summary to user**:

   ```
   ✅ REASONS-Canvas prompt generated and saved to `aupro/prompt/<file-name>.md`
...
A fully-populated, implementation-ready REASONS-Canvas structured prompt saved to `aupro/prompt/<file-name>.md`, then implementation upon user confirmation.
