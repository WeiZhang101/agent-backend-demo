...
**Input**: The argument after `/aupro-generate` is the path to the structured prompt file (e.g., `@aupro/prompt/GGQPA-XXX-202602271430-[Feat]-api-create-agent-endpoint.md`).
...
1. **If no input provided, ask for the prompt file**
   ...
   > "Please provide the path to the structured prompt file (e.g., `@aupro/prompt/xxx.md`)."
...
**Integration with /aupro-context**
...
├─────────────────────────────────────────────────────────────────────────┤
│                                                                          │
│  Phase 1: /aupro-context                                                │
│  ┌────────────────────────────────────────────────────────────────┐    │
│  │ Requirement → Alignment → Abstraction → Structured Prompt      │    │
│  │                                                                 │    │
│  │ Output: aupro/prompt/GGQPA-XXX-*.md (REASONS Canvas)           │    │
│  └────────────────────────────────────────────────────────────────┘    │
│                              │                                          │
│                              ▼                                          │
│  Phase 2: /aupro-generate                                               │
│  ┌────────────────────────────────────────────────────────────────┐    │
