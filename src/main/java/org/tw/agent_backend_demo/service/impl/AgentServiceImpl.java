...
public class AgentServiceImpl implements AgentService {
    ...
    public CreateAgentResponse createAgent(CreateAgentRequest request) {
        ...
        // Initialize system fields using domain object method
        agent.initializeSystemFields("system"); // TODO: Replace with actual user context
     ...
     * 
     * @param visibilityScope the visibility scope to validate
     * @throws InvalidVisibilityScopeException if the scope is invalid
     */
    private void validateVisibilityScope(VisibilityScope visibilityScope) {
